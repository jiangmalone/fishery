...
public class LimitDaoImpl implements LimitDao {
	...
	public void updateLimit(Limit_Install limit_Install) {
		String sql = "update limit_install set high_limit=:high_limit,low_limit=:low_limit,up_limit=:up_limit,valid=:valid where device_sn = :device_sn and way = :way";
		...
		.setInteger("way", limit_Install.getWay())
		.setBoolean("valid", limit_Install.isValid()).executeUpdate();
