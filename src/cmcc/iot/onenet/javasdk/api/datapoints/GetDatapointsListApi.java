...
public class GetDatapointsListApi extends AbstractAPI{
	...
	public GetDatapointsListApi(String datastreamIds, String devId,Integer first, String sort,String key) {
		super();
		this.datastreamIds = datastreamIds;
		this.devId = devId;
		this.first = first;
        ...
        headmap.put("api-key", key);
        HttpMethod.setHeader(headmap);
        this.url = "http://api.heclouds.com" + "/devices/" + devId + "/datapoints";
        // url参数
        if (datastreamIds != null) {
            urlmap.put("datastream_id", datastreamIds);
        }
